...
const DialogBox = ({dialog, setshowinfo, setshowalert}) => {
	...
	const infoDialogBox = 	<div className = "info-dialog">
								...
								<ol>
									...
									<li>"Visualize" option shows the solving process in the grid. Visualization options become available during the process which allows to control the speed of visualization.</li>
									<li>"Show Solution" option displays the result in the grid. This option is available only during visualization.</li>
									<li>
										"Upload File" option allows user to upload text file ('.txt') containing sudoku. The sudoku grid will be auto populated with sudoku present in the uploaded file. 
									...
									<li>"Clear Solution" option removes the solved part of the sudoku grid leaving only puzzle digits that were entered.</li>
									<li>"Clear Grid" option empties the sudoku grid.</li>
